...
public final class StringUtils {
  ...
  private static final DateTimeFormatter SHORT_FORMAT =
	...
	private static final DateTimeFormatter SHORT_FORMAT_SERVER =
  ...
  public static String epochTimestampToMediumUTCDateString(long timestampMs, Locale locale) {
	...
	public static String epochTimestampToServerDateString(long timestampMs) {
		Date myDate = new Date(timestampMs);
  		return getDateFormat().format(myDate);
	}
}
