...
public class ExposureNotificationPermissionHelper implements LifecycleObserver {
  ...
  public ExposureNotificationPermissionHelper(Activity host, Callback callback) {
    this.host = host;
   ...
   */
  public void optInAndStartExposureTracing(Activity activity) {
    if (activity == null) {
  ...
  public static ListenableFuture<Boolean> isEnabled(Context context) {
