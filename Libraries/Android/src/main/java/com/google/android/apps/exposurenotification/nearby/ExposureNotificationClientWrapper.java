...
public class ExposureNotificationClientWrapper {
  ...
  private static ExposureNotificationClientWrapper sINSTANCE;
  ...
  public static ExposureNotificationClientWrapper get(Context context) {
    if (sINSTANCE == null) {
      sINSTANCE = new ExposureNotificationClientWrapper(context);
    }
    return sINSTANCE;
  }
  ...
  public Task<Void> provideDiagnosisKeys(List<File> files, String token) {
    //ExposureConfiguration exposureConfiguration = new ExposureConfiguration.ExposureConfigurationBuilder().build();

    	// Provider our own custom configuration !!
	  	// copy our exposureConfiguration over the API one.
	  	ExposureConfiguration exposureConfiguration = ExposureNotificationsAPI.copyExposureConfigurationFromEntity();
	  	Services.Log.debug("provideDiagnosisKeys exposureConfiguration: " + exposureConfiguration.toString() );
